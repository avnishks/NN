library(MASS)
library(ISLR)
P1s1 <- read.csv('/home/avnish/R/my_data/Dataset2/Exp 1 Data - 20 Subjects/P_22_s4data.csv', header=TRUE)#stringsAsFactors = FALSE
#modify data
...
# Write CSV in R
write.csv(P1s1, file = "newP_22_s4data.csv", na = "NaN", row.names=FALSE, quote = FALSE)
